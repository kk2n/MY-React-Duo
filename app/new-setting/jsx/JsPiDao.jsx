                            ...
                            {this.state.isname.length > 0 && (
                                <span>
                                    <br />您导入的数据中，有<span
                                        style={{ color: "#f00" }}
                                    >
                                        【第{this.state.isname.join("，")}行的教室名称为空】
                                    </span>的数据！
                                </span>
                            )}
                            {this.state.isaddress.length > 0 && (
                                <span>
                                    <br />您导入的数据中，有<span
                                        style={{ color: "#f00" }}
                                    >
                                        【第{this.state.isaddress.join("，")}行的教室地址为空】
                                    </span>的数据！
                                </span>
                            )}
                            {this.state.istype.length > 0 && (
                                <span>
                                    <br />您导入的数据中，有<span
                                        style={{ color: "#f00" }}
                                    >
                                        【第{this.state.istype.join("，")}行的教室类别为空】
                                    </span>的数据！
                                </span>
                            )}
                            {this.state.iszuowei.length > 0 && (
                                <span>
                                    <br />您导入的数据中，有<span
                                        style={{ color: "#f00" }}
                                    >
                                        【第{this.state.iszuowei.join("，")}行的教室座位数为空】
                                    </span>的数据！
                                </span>
                            )}
                                ...
                                <span>
                                    ...
                                    >
                                        【第{this.state.isnamerephang.join(
                                            "，"
                                        )}行】，【教室名称为{this.state.isnamerep.join(
                                            "，"
                                        )}】
                                    </span>的数据重复，请检查您的数据！
                                </span>
                            ...
                            {this.state.isrep.length > 0 && (
                                <span>
                                    <br />您导入的数据中，<span
                                        style={{ color: "#f00" }}
                                    >
                                        【课程名称为{this.state.isnamerep.join(
                                            "，"
                                        )}】
                                    </span>的数据重复，请检查您的数据！
                                </span>
