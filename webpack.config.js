...
module.exports = {
    ...
    output: {
        path: __dirname + "/public", //js输出路径
        //publicPath: '/',//打包发布文件中所有通过相对路径引用的资源都会被配置的路径所替换
    ...
    module: {
        ...
        rules: [
            ...
            {
                test: /\.(png|jpg|gif)$/,
                loader: 'url-loader?limit=8192&name=../common/img/[name].[ext]'
            },
            //编译js和jsx
            {
                //匹配文件
